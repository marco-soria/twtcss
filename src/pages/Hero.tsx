...
export const Hero = () => {
  return (
      ...
      <div className="bg-zinc-200 dark:bg-slate-900">
        ...
        className="bg-zinc-200 dark:bg-zinc-900 flex h-[calc(100vh-200px)] min-h-[400px] flex-col items-center justify-center bg-cover bg-fixed bg-center bg-hero text-zinc-200"
      >
        <div
